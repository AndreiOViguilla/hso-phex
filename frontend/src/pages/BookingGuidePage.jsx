...
export default function BookingGuidePage({ onBack }) {
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", background: t.bg }}>
      <div style={{ background: dark ? "#1e293b" : "#1e3a8a", color: "#fff", padding: "14px 24px", display: "flex", alignItems: "center", gap: 12, borderBottom: dark ? `1px solid ${t.cardBorder}` : "none" }}>
